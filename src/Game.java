...
public class Game extends Canvas implements Runnable {
   ...
   // private MovingBackground mb;
    ...
    public void init(){ // initialise
        requestFocus(); //focus directly on the opened game
        BufferedImageLoader loader = new BufferedImageLoader();
        //load the png with all png items
        try{
            //String base = System.getProperty("user.dir");
            //System.out.println("Working dir: " + base);
            //String base_sprite = base + "/res/sprite_sheets.png";
            //String background_sprite = base + "/res/background.png";

            String base_sprite = "/res/sprite_sheets.png";
            String background_sprite = "/res/background.png";

            spriteSheet = loader.loadImage(base_sprite);
            background = loader.loadImage(background_sprite);
            System.out.println();
        }catch (IOException e){
            e.printStackTrace();
        }
